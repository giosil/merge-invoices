...
<xsl:stylesheet version="1.1"
	...
	<xsl:template name="AltraDescrizioneLinea">
		<xsl:param name="textDescrizione" /> <!-- testo della descrizione -->
		<tr>
			<td />
			<td>
				<div class="tx-xsmall">
	...
	<xsl:template name="FatturaElettronica">
		...
		<xsl:if test="$TipoFattura">
			<!--Variabile che contiene il codice destinatario dall'HEADER perche' viene visualizzato nella sezione BODY -->
			...
			<div id="fattura-elettronica" class="page">
									...
									<tr>
										<td>
											...
											<div class="headBorder">
												...
												<xsl:if
													test="$TipoFattura/FatturaElettronicaHeader/CedentePrestatore">
													<xsl:for-each
														select="$TipoFattura/FatturaElettronicaHeader/CedentePrestatore/DatiAnagrafici">
														...
														<div class="headContent">
															<xsl:if
																test="Anagrafica/Nome | Anagrafica/Cognome">
																Cognome nome:
															...
															<xsl:if test="RegimeFiscale">
																...
																<xsl:choose>
																	...
																	<xsl:when test="$RF='RF10'">
																		(intrattenimenti, giochi e altre attività di cui alla
																		tariffa allegata al DPR 640/72)
																	</xsl:when>
								...
								<table class="tableHead">
									<tr>
										<td>
											...
											<div class="headBorder">
												<label class="headerLabel">Cessionario/committente
													(cliente)
												</label>
												<xsl:if
													test="$TipoFattura/FatturaElettronicaHeader/CessionarioCommittente">
													<xsl:for-each
														select="$TipoFattura/FatturaElettronicaHeader/CessionarioCommittente/DatiAnagrafici">
														<div class="headContent mt5">
															<xsl:if test="IdFiscaleIVA">
																Identificativo fiscale ai fini IVA:
																<span>
													...
													<xsl:for-each
														select="$TipoFattura/FatturaElettronicaHeader/CessionarioCommittente/Sede">
														<div class="headContent">
															<xsl:if test="Indirizzo">
																Indirizzo:
																<span>
				...
				<!--INIZIO BODY -->
				<xsl:for-each
					select="$TipoFattura/FatturaElettronicaBody">
					...
					<table class="tbFoglio">
						...
						<tbody>
							<xsl:for-each
								select="DatiBeniServizi/DettaglioLinee">
		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.headBorder
					{
					<!--border: 2px solid black; width:100%; height: 210px; border-bottom-left-radius:30px; 
